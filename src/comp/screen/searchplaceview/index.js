...
const list = [
	{ name: "Alice", country: "Aruba" },
	{ name: "Bob", country: "Canada" },
	{ name: "Charlie", country: "Mexico" },
	{ name: "David", country: "Brazil" },
	{ name: "Emma", country: "Argentina" },
	{ name: "Frank", country: "UK" },
	{ name: "Grace", country: "France" },
	{ name: "Henry", country: "Germany" },
	{ name: "Ivy", country: "Italy" },
	{ name: "John", country: "Spain" },
	{ name: "Kate", country: "Japan" },
	{ name: "Liam", country: "China" },
	{ name: "Mia", country: "India" },
	{ name: "Noah", country: "Australia" },
	{ name: "Olivia", country: "New Zealand" }
  ];
...
const SearchPlaceView = (props) => {
	...
	const [userDsiplay, setuserDisplay] = useState(false)
	...
	const searchPlaceFromKeyword = (placeName) => {
		...
		//console.log(isStateSearchEnabled)
...
///// sort out the country which contain a character from a country from the map array 
		if (isCountrySearchEnabled) {
			//filterCountryArray = MasterWorldArray.map((item) => {
			//	console.log(lodash.omit(item, ["states"]));
			//	return lodash.omit(item, ["states"]);
			//});
			filterCountryArray = list
	...
	const onPressPlaceItem = async (placeItem) => {
		var country = MasterWorldArray.find(obj => obj.name === placeItem.country)
		//console.log(country)
		await props.setUserConfig({
			...userConfig,
			selectedPlaceItem: country,
			isPlaceVisible: true,
		});
		////which is option is selected
			...
			>
				<AutoComplete
					onSelectOption={(params) => {
						...
						//console.log(params?.item?.originalValue)
					}}
					...
					>
						{(state?.searchResultArray ?? []).map((item, index) => {
							...
							if (isFavPlace) {
								...
								//console.log(favPlaceIndex+isFavPlace+"l")
							}
